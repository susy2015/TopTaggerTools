...
def main():
    ...
    # --------------------------------- 
    basepath = "/uscms_data/d3/semrat/SUSY/CMSSW_11_2_0_pre5/src/Analyzer/Analyzer/test/condor/hadd_Run2UL_ResolvedTopTagger_fakeRateEfficiency_withDeepFlavor/"
    ...
    for year in years:
        ...
        #canvas = ROOT.TCanvas("c", "c", 0, 0, 600, 600)
        #legend = ROOT.TLegend(0.1,0.75,0.35,0.9) #0.6, 0.7, 0.9, 0.9
        #canvas.SetLogy()
        ...
        for histname in histnames:
            ...
            #    hists[hist].SetTitle(year)
            #    hists[hist].SetLineWidth(4)
            #    hists[hist].GetXaxis().SetTitle("Discriminator")
            #    hists[hist].GetYaxis().SetTitle("Normalized Events")
            #    hists[hist].SetAxisRange(0.0,1.0)
            #    hists[hist].RebinX(50)
            #    hists[hist].Draw("SAME HIST")
        
            #    legend.AddEntry(hists[hist],histnames[hist],"l")
            #
            #legend.Draw()
            #canvas.SaveAs("../../fakeRateEfficiencyPlots/Run2UL_DeepFlavor_Nov2022/" + year + "_Discriminator.pdf")
            #canvas.Close()
        ...
        ROC.SaveAs("../../fakeRateEfficiencyPlotsThesis/Run2UL_DeepFlavor_FullStatusTalk/" + year + "_ROC_WPs.pdf")
        ROC.Close()
