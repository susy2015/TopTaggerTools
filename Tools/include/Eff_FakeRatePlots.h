...
public:
    ...
    void makeTH1F(std::string name, const char* rootFile, std::string type, std::string wp)
    {
        ...
        ratioTH1F(name,  name + "genTopMatchPt_"+wp  ,name + "genTopPt"          ,rootFile ,name + "efficiencyGenTopMatchPt"  ,type ,"P_{T} (GeV)"   ,"Efficiency", 5);
        ratioTH1F(name,  name + "genTopMatchMass_"+wp,name + "genTopMass"        ,rootFile ,name + "efficiencyGenTopMatchMass",type ,"Mass (GeV)"    ,"Efficiency", 1);	
        ratioTH1F(name,  name + "genTopMatchEta_"+wp ,name + "genTopEta"         ,rootFile ,name + "efficiencyGenTopMatchEta" ,type ,"#eta"          ,"Efficiency", 2);
    }
